...
class HotelRoomsOrderReportView(APIView):
    ...
    #         orders = HotelRoomsOrder.objects.all().order_by('-id')
...
class RestaurantFoodOrderReportView(APIView):
    ...
    #         orders = RestaurantFoodOrder.objects.all().order_by('-id')
...
class RestaurantDrinksOrderReportView(APIView):
    ...
    #         orders = RestaurantDrinksOrder.objects.all().order_by('-id')
...
class RetailsFoodOrderReportView(APIView):
    ...
    #         orders = RetailsFoodOrder.objects.all().order_by('-id')
...
class RetailsDrinksOrderReportView(APIView):
    ...
    #         orders = RetailsDrinksOrder.objects.all().order_by('-id')
